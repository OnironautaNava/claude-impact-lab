...
- Workspace-level SDD artifacts live at `/.atl/`.
- For feature work inside `smart-commute-cdmx/`, run the SDD flow from `smart-commute-cdmx/` and use `smart-commute-cdmx/.atl/skill-registry.md`.
- Do not resolve app-local skills for `smart-commute-cdmx` from the root registry.
