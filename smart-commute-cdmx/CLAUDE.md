...
- This app is the default SDD target for current product work.
- Use `smart-commute-cdmx/.atl/skill-registry.md` as the primary registry for delegation and skill resolution.
- Prefer running SDD exploration, proposals, specs, and tasks from the `smart-commute-cdmx/` working directory.
